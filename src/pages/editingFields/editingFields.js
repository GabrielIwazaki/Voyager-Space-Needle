                ...
                {!this.state.isHiddenForm && <div className="register-fields">
                    ...
                    <form onSubmit={this.registerField.bind(this)} className="form--add-field">
                        <div className="close--add-field">
                            <img src="https://image.flaticon.com/icons/svg/118/118773.svg" alt="" onClick={this.toggleHiddenForm.bind(this)} />
                        </div>
                            ...
                            <div className="field-types--higher">
                                ...
                                <div className="radio--field-types">
                                    <label for="list">
                                        ...
                                        <img src="https://image.flaticon.com/icons/svg/482/482559.svg"  alt="" />Lista</label>
                                ...
                                <div className="radio--field-types">
                                    <label for="multiple-selection">
                                        ...
                                        <img src="https://image.flaticon.com/icons/svg/2087/2087812.svg"  alt="" />Seleção Múltipla</label>
                                </div>
                                ...
                                <div className="radio--field-types">
                                    <label for="numeric">
                                        ...
                                        <img src="https://image.flaticon.com/icons/svg/56/56632.svg"  alt="" />Numérico</label>
                                </div>
                            ...
                            <div className="field-types--bottom">
                                ...
                                <div className="radio--field-types">
                                    <label for="text">
                                        ...
                                        <img src="https://image.flaticon.com/icons/svg/2087/2087728.svg"  alt="" />Texto</label>
                                </div>
                                ...
                                <div className="radio--field-types">
                                    <label for="date">
                                        ...
                                        <img src="https://image.flaticon.com/icons/svg/481/481787.svg"  alt="" />Data</label>
                                </div>
                                ...
                                <div className="radio--field-types">
                                    <label for="check-box">
                                        ...
                                        <img src="https://image.flaticon.com/icons/svg/2089/2089626.svg"  alt="" />Caixa de Seleção</label>
                                </div>
                            </div>
